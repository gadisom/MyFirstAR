...
`var dotNodes = [SCNNode]() /` : 점들의 위치를 저장하기 위해서 선언 
...
![IMG_A00905DF131C-1.jpeg](ARRuler%20661bfedd2f0d4342913c2270e449e6af/IMG_A00905DF131C-1.jpeg)
...
3회 이상터치의 경우 점 배열을 초기화해주고 

text 가 업데이트 될때마다 앞에 있는 textNode를 초기화한다.